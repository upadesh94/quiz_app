  ...
  return (
    <Pressable
      ...
      style={({ pressed }) => [
        ...
        variant === 'primary'
          ? { backgroundColor: colors.primary, borderWidth: 1, borderColor: isDark ? '#2563EB' : '#1D4ED8' }
          : { backgroundColor: colors.card, borderWidth: 1, borderColor: isDark ? 'rgba(168, 85, 247, 0.5)' : '#BFDBFE' },
    ...
    >
      ...
      <Text
        style={{
          color: variant === 'primary' ? '#FFFFFF' : isDark ? '#d8b4fe' : '#1E3A8A',
          fontWeight: '700',
